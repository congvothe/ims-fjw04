...
```
cd existing_repo
git remote add origin https://gitlab.com/hhnguyen1196/ims-fjw04.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.com/hhnguyen1196/ims-fjw04/-/settings/integrations)
